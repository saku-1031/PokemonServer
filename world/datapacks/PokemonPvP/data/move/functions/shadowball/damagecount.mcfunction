...
scoreboard players operation @s tmp1 *= @e[tag=shadowballarmor] movelevelstatus
scoreboard players operation @s tmp1 /= #5 Const
scoreboard players operation @s tmp1 += #2 Const
scoreboard players operation @s tmp1 *= @e[tag=shadowballarmor] movepowerstatus
scoreboard players operation @s tmp1 *= @e[tag=shadowballarmor] moveattackstatus 
