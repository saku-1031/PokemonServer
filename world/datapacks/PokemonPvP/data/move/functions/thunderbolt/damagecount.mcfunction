...
scoreboard players operation @s tmp1 *= @e[tag=thunderboltarmor] movelevelstatus
scoreboard players operation @s tmp1 /= #5 Const
scoreboard players operation @s tmp1 += #2 Const
scoreboard players operation @s tmp1 *= @e[tag=thunderboltarmor] movepowerstatus
scoreboard players operation @s tmp1 *= @e[tag=thunderboltarmor] moveattackstatus 
