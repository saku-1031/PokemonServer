...
scoreboard players operation @s tmp1 = @s EvSpAttack

scoreboard players operation @s tmp0 += @s RvSpAttack
scoreboard players operation @s tmp0 *= #2 Const
scoreboard players operation @s tmp0 += @s IvSpAttack
...
scoreboard players operation @s SpAttack = @s tmp0
