...
scoreboard players operation @s tmp1 = @s EvHP

scoreboard players operation @s tmp0 += @s RvHP
scoreboard players operation @s tmp0 *= #2 Const
scoreboard players operation @s tmp0 += @s IvHP
...
scoreboard players operation @s tmp0 += #10 Const
scoreboard players operation @s tmp0 += @s Level
scoreboard players operation @s HP = @s tmp0
