...
scoreboard players operation @s tmp1 = @s EvSpeed

scoreboard players operation @s tmp0 += @s RvSpeed
scoreboard players operation @s tmp0 *= #2 Const
scoreboard players operation @s tmp0 += @s IvSpeed
...
scoreboard players operation @s Speed = @s tmp0
