...
scoreboard players operation @s tmp1 = @s EvDefence

scoreboard players operation @s tmp0 += @s RvDefence
scoreboard players operation @s tmp0 *= #2 Const
scoreboard players operation @s tmp0 += @s IvDefence
...
scoreboard players operation @s Defence = @s tmp0
