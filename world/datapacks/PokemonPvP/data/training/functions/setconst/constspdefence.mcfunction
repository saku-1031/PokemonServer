...
scoreboard players operation @s tmp1 = @s EvSpDefence

scoreboard players operation @s tmp0 += @s RvSpDefence
scoreboard players operation @s tmp0 *= #2 Const
scoreboard players operation @s tmp0 += @s IvSpDefence
...
scoreboard players operation @s SpDefence = @s tmp0
